...
public class GooglyOverlay {

    private boolean usingFrontCamera;
    private GraphicOverlay mGraphicOverlay;

    public GooglyOverlay(boolean usingFront, GraphicOverlay overlay){
    ...
    public FaceDetector createFaceDetector(Context context) {
        ...
        if (usingFrontCamera) {
            ...
            Tracker<Face> tracker = new GooglyEyesFaceTracker(mGraphicOverlay);
